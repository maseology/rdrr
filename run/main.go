...
func main() {
	...
	TMQm, grdMin, kstrm, mcasc, soildepth, dinc, urbDiv := 0.803918, 0.000835, 0.995398, 0.256054, 0.117458, 1.489587, .9
	ksat := []float64{8.38e-11, 2.66e-09, 2.57e-07, 1.04e-05, 7.50e-05, 2.37e-07, 4.67e-08, 1.23e-07}
