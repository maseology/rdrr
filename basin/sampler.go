...
func par5(u []float64) (m, smax, dinc, soildepth, kfact float64) {
	...
	soildepth = mmaths.LinearTransform(0., 1., u[3])   // depth of soilzone/ET extinction depth
	kfact = mmaths.LogLinearTransform(0.1, 10., u[4])  // global surficial geology adjustment factor
	return
}
