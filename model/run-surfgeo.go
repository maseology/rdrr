...
func (d *Domain) RunSurfGeo(mdldir, chkdir string, topm, grdMin, kstrm, mcasc, soildepth, dinc float64, ksat []float64, outlet int, print bool) float64 {
	tt := mmio.NewTimer()
	...
	smpl := b.surfgeoSample(topm, grdMin, kstrm, mcasc, soildepth, ksat)
	smpl.dir = mdldir
	if print {
