...
func par4(u []float64) (m, grng, soildepth, kfact float64) {
	m = mmaths.LogLinearTransform(0.1, 100., u[0])         // topmodel m -- NOTE anything less than 0.01 can lead to overflows
	...
	kfact = mmaths.LogLinearTransform(0.001, 10000., u[3]) // global surficial geology adjustment factor
	return
}
